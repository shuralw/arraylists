...
namespace Finanzuebersicht.Backend.Admin.Core.API.Modules.Accounting.Categories.DTOs
{
    public class Class
    {
        private void xd()
        {
            ...
            string animal = animals[r.Next(0, x.Length - 1)];
        }
